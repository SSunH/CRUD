        ...
        <div class="bg-white lg:w-6/12 md:7/12 w-6/12 shadow-3xl rounded-xl mx-auto border border-black">
            ...
            <div class="p-10 md:p-20">
                <div class="flex items-center text-lg mb-6 md:mb-8">
                    ...
                    <input type="text" id="id" name="id" class="bg-gray-200 rounded pl-12 py-2 md:py-4 focus:outline-none w-full" placeholder="id" />
                </div>
                <div class="flex items-center text-lg mb-6 md:mb-8">
                ...
                <button type="button" onclick="submitForm()" class="bg-gradient-to-b from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded">Login</button>
            </div>
        </div>
    </div>
</body>
